...
--
-- Host: localhost
-- Generation Time: Jun 10, 2025 at 03:52 PM
...
--
-- Table structure for table `ai_assistant_calls`
--
...
CREATE TABLE `ai_bots` (
  ...
  `resource` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `max_interactions` int NOT NULL,
  `max_silince` int NOT NULL,
  `waiting_tone` int DEFAULT NULL,
  `inaudible_voice` int DEFAULT NULL,
  `listening_tone` int DEFAULT NULL,
  `internal_directory` int NOT NULL,
  `email` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `create_support_ticket` tinyint NOT NULL DEFAULT '0',
  `function_id` int NOT NULL,
  `destination_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `call_transfer_tone` int DEFAULT NULL,
  `tts_profile_id` int DEFAULT NULL,
  `stt_profile_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `ivrs` (
  ...
  `intent_analyzer` text COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(130, '2025_01_13_164434_add_duration_into_queue_calls_table', 51),
(132, '2025_01_19_121050_create_ai_bots_table', 52),
(133, '2025_01_19_162506_update_sip_user_table', 52),
(134, '2025_02_04_174552_create_ai_conversations_table', 52),
(135, '2025_02_05_163616_create_ai_assistant_calls_table', 52),
(136, '2025_02_13_170029_update_language_and_model_fields_in_tts_profiles_table', 52),
(137, '2025_02_25_124810_add_call_transfer_tone_field_into_ai_bots_table', 53),
(138, '2025_02_27_123515_add_max_extension_field_into_organizations_table', 54),
(139, '2025_03_06_132245_add_fields_into_ai_bots_table', 55),
(140, '2025_03_09_131611_add_field_response_timeout_into_tts_histroies_table', 55),
(141, '2025_03_11_121854_update_status_field_in_leads_table', 55),
(142, '2025_03_09_131611_add_field_response_time_into_tts_histroies_table', 56),
(143, '2025_04_13_124030_add_intent_analyzer_field_into_ivrs_table', 56),
(144, '2025_04_21_165602_add_intent_analyzer_field_into_surveys_table', 56),
(145, '2025_01_14_153703_add_call_limit_and_expire_date_into_organizations_table', 57),
(146, '2025_04_24_183853_add_is_primary_field_into_organizations_table', 58),
(147, '2025_04_28_123859_update_organization_tables', 58);
...
CREATE TABLE `organizations` (
  ...
  `max_extension` int NOT NULL DEFAULT '0',
...
--
-- Indexes for table `ai_assistant_calls`
--
ALTER TABLE `ai_assistant_calls`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ai_assistant_calls`
--
ALTER TABLE `ai_assistant_calls`
