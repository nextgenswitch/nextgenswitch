...
class LeadsController extends Controller
{
                ...
                $callback = function() use($leads, $columns) {
                    ...
                    foreach ($leads as $lead) {
                        ...
                        foreach($columns as $column){
                            ...
                            if($column == 'status'){
                                $row[$column] = config('enums.lead_status')[$lead->{$column}];
                            }
                            else{
    ...
    public function create(Request $request)
    {
        ...
        if($request->ajax())
            return view('leads.form', compact('organizations'))->with(['action'=>route('leads.lead.store'),'lead' => null,'method'=>'POST']);
        else
    ...
    public function edit($id, Request $request)
    {
        ...
        if($request->ajax())
            return view('leads.form', compact('lead','organizations'))->with(['action'=>route('leads.lead.update',$id),'method'=>'PUT']);
        else
            return view('leads.edit', compact('lead','organizations'));
    }
