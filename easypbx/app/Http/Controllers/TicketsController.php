...
class TicketsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $ticketCounts = Ticket::where('organization_id', auth()->user()->organization_id)
        ...
        if($request->ajax()){
            return view('tickets.table', compact('tickets', 'ticketCounts'));
        } 
        
        return view('tickets.index', compact('tickets', 'ticketCounts'));
