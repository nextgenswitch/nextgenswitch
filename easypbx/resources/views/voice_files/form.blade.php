...
<div class="form-group @error('file_name') has-error @enderror">
    ...
    <span class="text-required">*</span>
        ...
        {!! Form::file('file',  ['class' => 'form-control' . ($errors->has('file_name') ? ' is-invalid' : null), 'minlength' => '1', 'maxlength' => '255', 'required' => false, 'placeholder' => __('place_voice_file'),'accept'=>".mp3" ]) !!}
