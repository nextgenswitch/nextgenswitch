...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="tile-title">{{ __('Outbound Routes') }}</h4>
            </div>

            <div class="btn-group btn-group-sm pull-right" role="group">
                <!-- <a href="{{ route('outbound_routes.outbound_route.create', 1) }}" class="btn btn-primary mx-2"
                    title="{{ __('Create API Outbound Route') }}">
                    <span class="fa fa-plus" aria-hidden="true"></span>{{ __('Create API Outbound Route') }}
                </a> -->

                <a href="{{ route('outbound_routes.outbound_route.create') }}" class="btn btn-primary"
                    title="{{ __('Create New Outbound Route') }}">
                    <span class="fa fa-plus" aria-hidden="true"></span>{{ __('Create New Outbound Route') }}
                </a>
            </div>
            ...
            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                        ...
                        <div class="btn-group btn-group-sm py-2" role="group"
                            ...
                            <div id="sampleTable_filter" class="dataTables_filter btn-group btn-group-sm">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow-dropdown" aria-labelledby="btnFilter">
                                    <a class="dropdown-item" href="{!! route('outbound_routes.outbound_route.index') !!}">{{ __('All') }}</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                        href="{!! route('outbound_routes.outbound_route.index') !!}?filter=is_active:1">{{ __('Active') }}</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                        href="{!! route('outbound_routes.outbound_route.index') !!}?filter=is_active:0">{{ __('Inactive') }}</a>
                                </div>
                            </div>
                ...
                <div class="table-responsive">
                    <div id="crud_contents">
                        @include ('outbound_routes.table', ['outboundRoutes' => $outboundRoutes])
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{!! route('outbound_routes.outbound_route.bulk') !!}" class="editableForm" id="massActionFrm"
    ...
    <div class="modal fade drawer right-align" id="FormModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('Create New Outbound Route') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
