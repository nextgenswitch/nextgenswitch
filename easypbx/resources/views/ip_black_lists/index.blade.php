...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="tile-title">{{ __('Ip Black Lists') }}</h4>
            </div>

            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('ip_black_lists.ip_black_list.create') }}" class="btn btn-primary btnForm"
                    title="{{ __('Create New Ip Black List') }}">
                    <span class="fa fa-plus" aria-hidden="true"></span>{{ __('Create New Ip Black List') }}
                </a>
            </div>
            ...
            <div class="table-responsive">
                ...
                <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                            ...
                            <div class="btn-group btn-group-sm py-2" role="group"
                                ...
                                <div id="sampleTable_filter" class="dataTables_filter btn-group btn-group-sm">
                                    ...
                                    <div class="dropdown-menu shadow-dropdown" aria-labelledby="btnFilter">
                                        <a class="dropdown-item" href="{!! route('ip_black_lists.ip_black_list.index') !!}">{{ __('All') }}</a>
                    ...
                    <div id="crud_contents">
                        @include ('ip_black_lists.table', ['ipBlackLists' => $ipBlackLists])
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{!! route('ip_black_lists.ip_black_list.bulk') !!}" class="editableForm" id="massActionFrm"
