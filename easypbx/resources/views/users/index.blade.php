...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="tile-title">{{ __('Users') }}</h4>
            </div>

            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('users.user.create') }}" class="btn btn-primary btnForm"
                    title="{{ __('Create New User') }}">
                    <span class="fa fa-plus" aria-hidden="true"></span>{{ __('Create New User') }}
                </a>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{!! route('users.user.bulk') !!}" class="editableForm" id="massActionFrm"
