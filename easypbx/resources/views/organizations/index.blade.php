...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="tile-title">{{ __('Tenants') }}</h4>
            </div>

            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('organizations.organization.create') }}" class="btn btn-primary btnForm"
                    title="{{ __('Create New Tenant') }}">
                    <span class="fa fa-plus" aria-hidden="true"></span>{{ __('Create New Tenant') }}
                </a>
            </div>
            ...
            <div class="table-responsive">
                ...
                <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                            ...
                            <div class="btn-group btn-group-sm py-2" role="group"
                                ...
                                <div id="sampleTable_filter" class="dataTables_filter btn-group btn-group-sm">
                                    ...
                                    <div class="dropdown-menu shadow-dropdown" aria-labelledby="btnFilter">
                                        <a class="dropdown-item" href="{!! route('organizations.organization.index') !!}">{{ __('All') }}</a>
                                    </div>
                                </div>
                    ...
                    <div id="crud_contents">
                        @include ('organizations.table', ['organizations' => $organizations])
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{!! route('organizations.organization.bulk') !!}" class="editableForm" id="massActionFrm"
    ...
    <div class="modal fade drawer right-align" id="FormModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('Create New Organization') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
