                                 ...
                                 <form method="POST" action="{!! route('ivrs.ivr.destroy', $ivr->id) !!}" accept-charset="UTF-8" class="deleteFrm">
                                   ...
                                   @method('DELETE')   
                                    ...
                                    <ul class="dropdown-menu shadow-dropdown action-dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                      ...
                                      <li><a  class="dropdown-item" href="{{ route('ivr_actions.ivr_action.index', $ivr->id ) }}">
                                            <i data-feather="link"></i> {{ __('IVR Action') }}
                                        </a>


                                        <li><a title="Edit Ivr #{{ $ivr->id }}" class="dropdown-item btnForm" href="{{ route('ivrs.ivr.edit', $ivr->id ) }}">
