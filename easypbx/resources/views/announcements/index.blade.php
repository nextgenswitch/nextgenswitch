...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="tile-title">{{ __('Announcements') }}</h4>
            </div>

            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('announcements.announcement.create') }}" class="btn btn-primary btnForm"
                    title="{{ __('Create New Announcement') }}">
                    <span class="fa fa-plus" aria-hidden="true"></span>{{ __('Create New Announcement') }}
                </a>
            </div>
            ...
            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                        ...
                        <div class="btn-group btn-group-sm py-2" role="group"
                            ...
                            <div id="sampleTable_filter" class="dataTables_filter btn-group btn-group-sm">
                                ...
                                <div class="dropdown-menu shadow-dropdown dropdown-menu-right" aria-labelledby="btnFilter">
                                    <a class="dropdown-item" href="{!! route('announcements.announcement.index') !!}">{{ __('All') }}</a>
                                </div>
                            </div>
                ...
                <div class="table-responsive">
                    <div id="crud_contents">
                        @include ('announcements.table', ['announcements' => $announcements])
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{!! route('announcements.announcement.bulk') !!}" class="editableForm" id="massActionFrm"
    ...
    <div class="modal fade drawer right-align" id="FormModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('Create New Announcement') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            destinations = "{{ route('announcements.announcement.destinations', 0) }}"
