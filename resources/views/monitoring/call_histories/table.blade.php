                ...
                @foreach ($calls as $call)
                    <tr data-call-id="{{ $call->call_id }}" data-bridge-call-id="{{ $call->bridge_call_id }}">
                        ...
                        <td class="voice-preview">
                            ...
                            <a class="btn btn-outline-primary btn-sm" href="{{ route('voice_files.voice.download', base64_encode($call->record_file) ) }}"><i class="fa fa-download"></i></a>
                            
                            <span class="btn btn-outline-primary btn-sm btn-summarize-conversation" record_file="{{$call->record_file}}"><i class="fa fa-comments-o"></i></span>
                            @endif
                        </td>
