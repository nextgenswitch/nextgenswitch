                  ...
                  @foreach ($mailProfiles as $mailProfile)
                      <tr>
                          ...
                          <td>
                              ...
                              <form method="POST" action="{!! route('mail_profiles.mail_profile.updateField', $mailProfile->id) !!}" class="editableForm"
                          ...
                          <td>
                              ...
                              <div class="dropdown">
                                  <form method="POST" action="{!! route('mail_profiles.mail_profile.destroy', $mailProfile->id) !!}" accept-charset="UTF-8"
                                      class="deleteFrm">
                                      @csrf
                                      @method('DELETE')
                                      ...
                                      <ul class="dropdown-menu shadow-dropdown action-dropdown-menu"
                                          ...
                                          <li><a title="Edit Sms Profile #{{ $mailProfile->id }}" class="dropdown-item"
                                                  href="{{ route('mail_profiles.mail_profile.edit', $mailProfile->id) }}">
                                                  <i data-feather="edit"></i> {{ __('Edit') }}
                                              </a>
                                          </li>
                                          <li>
                                              <a class="dropdown-item send-test-mail"
                                                  data-mid = "{{ $mailProfile->id }}" href="#">
                                                  <i data-feather="send"></i> {{ __('Test Mail') }}
                                              </a>
                                          </li>
                                          <li>
