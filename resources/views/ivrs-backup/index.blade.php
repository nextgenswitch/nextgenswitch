    ...
    <div class="panel panel-default">
          ...
          <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('ivrs.ivr.create') }}" class="btn btn-primary btnForm" title="{{ __('Create New Ivr') }}">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form method="POST" action="{!! route('ivrs.ivr.bulk') !!}" class="editableForm" id="massActionFrm" accept-charset="UTF-8">
             {{ csrf_field() }}    
  ...
  <div class="modal-dialog text-center" role="document">
    <div class="modal-content">
      ...
      <audio id="audio-player" controls="">
        <source id="audio-src" src="https://EasyPBX.infosoftbd.com/uploads/8/1257026734.mp3" type="audio/mpeg">
