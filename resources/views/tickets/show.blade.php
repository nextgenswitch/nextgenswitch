...
<div class="panel panel-default">
    ...
    <div class="pull-left">
        <h4 class="tile-title">{{ __('Ticket #') }} {{ optional($ticket)->phone }} </h4>
    </div>

    <div class="btn-group btn-group-sm pull-right" role="group">
        <a href="{{ route('tickets.ticket.index') }}" class="btn btn-outline-primary btn-sm">
            {{ __('Back to tickets') }}
        </a>
    </div>
    ...
    <div class="panel-heading clearfix ticket-summery">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-center">
                    ...
                    @else 
                        <a href="{{ route('tickets.ticket.assign', $ticket->id) }}">Assign me</a>
                    @endif
                </div>
            </div>
        ...
        @if($ticket->status < 3 && $ticket->user_id == auth()->id())
            <form action="{{ route('tickets.follow_up.store', $ticket->id) }}" class="p-md-3" method="post">
                ...
                <div class="form-group">
                    <textarea name="comment" id="comment" placeholder="Write a reply here..." class="form-control"></textarea>
                </div>
                <button class="btn btn-primary" type="submit">Reply Ticket</button>
            ...
            <li>
                ...
                <div class="timeline-body">
                    <div class="timeline-header d-flex">
                        <span class="user-avatar">{{ generateUserAvatar($flup->user->name) }} </span>
