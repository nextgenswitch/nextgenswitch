                  ...
                  @foreach ($smsProfiles as $smsProfile)
                      <tr>
                          ...
                          <td>
                              ...
                              <form method="POST" action="{!! route('sms_profiles.sms_profile.updateField', $smsProfile->id) !!}" class="editableForm"
                          ...
                          <td>
                              ...
                              <div class="dropdown">
                                  <form method="POST" action="{!! route('sms_profiles.sms_profile.destroy', $smsProfile->id) !!}" accept-charset="UTF-8"
                                      class="deleteFrm">
                                      @csrf
                                      @method('DELETE')
                                      ...
                                      <ul class="dropdown-menu shadow-dropdown action-dropdown-menu"
                                          ...
                                          <li><a title="Edit Sms Profile #{{ $smsProfile->id }}" class="dropdown-item"
                                                  href="{{ route('sms_profiles.sms_profile.edit', $smsProfile->id) }}">
                                                  <i data-feather="edit"></i> {{ __('Edit') }}
                                              </a>
                                          </li>
                                          <li>
                                              <a class="dropdown-item send-test-sms"
                                                  data-sms_id = "{{ $smsProfile->id }}" href="#">
                                                  <i data-feather="send"></i> {{ __('Test SMS') }}
                                              </a>
                                          </li>
