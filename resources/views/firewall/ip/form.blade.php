...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="form-group @error('title') has-error @enderror">
            ...
            {!! Form::text('title', old('title', optional($ipBlackList)->title), [
    ...
    <div class="col-lg-12">
        <div class="form-group @error('ip') has-error @enderror">
            ...
            {!! Form::text('ip', old('ip', optional($ipBlackList)->ip), [
                'class' => 'form-control' . ($errors->has('ip') ? ' is-invalid' : null),
                'required' => true,
                'placeholder' => __('Enter ip here...'),
            ]) !!}
            @error('ip')
                <p class="help-block  text-danger"> {{ $message }} </p>
            @enderror
